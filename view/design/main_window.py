...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "护肝神器-版权所有比尔盖子"))
        ...
        self.label_11.setText(_translate("MainWindow", "关注【瞎推啥】公众号，获取Token，填入下面这个输入框。脚本运行结束之后会往手机微信上发通知。"))
