...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.reg_template_lb = QtWidgets.QLabel(self.verticalGroupBox2)
        ...
        self.log_lv = QtWidgets.QListWidget(self.verticalGroupBox2)
        self.log_lv.setObjectName("log_lv")
        self.verticalLayout_3.addWidget(self.log_lv)
        self.gridLayout_2.addWidget(self.verticalGroupBox2, 0, 0, 1, 1)
